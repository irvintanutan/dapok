...
public class CreateUsernameFragment extends Fragment {
    ...
    public static CreateUsernameFragment newInstance(String param1, String param2) {
        CreateUsernameFragment fragment = new CreateUsernameFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_create_username, container, false);
